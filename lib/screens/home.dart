        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              style: const ButtonStyle(
                  backgroundColor:
                  MaterialStatePropertyAll<Color>(Color.fromRGBO(42,147,209,1))),
              child: const Text(
                "Sign out",
                style: TextStyle(color: Color.fromRGBO(49, 49, 131, 1), fontWeight: FontWeight.bold),
              ),
            )
          ],
        ),
